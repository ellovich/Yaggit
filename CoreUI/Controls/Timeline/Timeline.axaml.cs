...
public class Timeline : ItemsControl
{
    ...
    public static readonly StyledProperty<eTimelineDisplayMode> ModeProperty = AvaloniaProperty.Register<Timeline, eTimelineDisplayMode>(
        nameof(Mode));

    public eTimelineDisplayMode Mode
    {
    ...
    static Timeline()
    {
        ...
        ModeProperty.Changed.AddClassHandler<Timeline, eTimelineDisplayMode>((t, e) => { t.OnDisplayModeChanged(e); });
    }

    private void OnDisplayModeChanged(AvaloniaPropertyChangedEventArgs<eTimelineDisplayMode> e)
    {
    ...
    private void SetItemMode()
    {
        if (ItemsPanelRoot is TimelinePanel panel)
        {
            ...
            if (Mode == eTimelineDisplayMode.Left)
            {
            ...
            else if (Mode == eTimelineDisplayMode.Right)
            {
                foreach (var item in items)
                {
            ...
            else if (Mode == eTimelineDisplayMode.Center)
            {
                foreach (var item in items)
                {
            ...
            else if (Mode == eTimelineDisplayMode.Alternate)
            {
                var left = false;
                foreach (var item in items)
                {
