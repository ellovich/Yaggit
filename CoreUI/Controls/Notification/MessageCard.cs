...
public abstract class MessageCard : ContentControl
{
    ...
    /// </summary>
    public static readonly StyledProperty<eNotificationType> NotificationTypeProperty =
        AvaloniaProperty.Register<MessageCard, eNotificationType>(nameof(NotificationType));
