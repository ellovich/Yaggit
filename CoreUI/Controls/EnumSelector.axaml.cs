...
public class EnumSelector : TemplatedControl
{
    ...
    public static readonly StyledProperty<bool> DisplayDescriptionProperty = AvaloniaProperty.Register<EnumSelector, bool>(
        nameof(DisplayDescription), true);
    ...
    public static readonly StyledProperty<bool> DisplayColorProperty = AvaloniaProperty.Register<EnumSelector, bool>(
        nameof(DisplayColor));

    public bool DisplayColor
    {
        get => GetValue(DisplayColorProperty);
    ...
    private List<EnumItemTuple> GenerateItemTuple()
    {
        ...
        foreach (var value in values)
        {
            ...
            var color = field?.GetCustomAttributes(typeof(AvaColorAttribute), false).FirstOrDefault();
...
/// <summary>
/// Позволяет добавлять тег AvaColor, по аналогии с Description
/// </summary>
