...
[TemplatePart(PART_CheckBox, typeof(CheckBox))]
public class DateSelector : DateSelectorBase, IClearControl
{
    public const string PART_Button = "PART_Button";
    public const string PART_Popup = "PART_Popup";
    public const string PART_TextBox = "PART_TextBox";
    public const string PART_Calendar = "PART_Calendar";
    public const string PART_CheckBox = "PART_CheckBox";
    ...
    public static readonly StyledProperty<DateTime?> SelectedDateProperty = AvaloniaProperty.Register<DateSelector, DateTime?>(
    ...
    public static readonly StyledProperty<string?> WatermarkProperty = AvaloniaProperty.Register<DateSelector, string?>(
        nameof(Watermark));
    ...
    public static readonly StyledProperty<bool> IsNullableProperty = AvaloniaProperty.Register<DateSelector, bool>(
        nameof(IsNullable), defaultBindingMode: BindingMode.TwoWay, defaultValue: false);
    ...
    static DateSelector()
    {
        SelectedDateProperty.Changed.AddClassHandler<DateSelector, DateTime?>((Selector, args) =>
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        _checkBox = e.NameScope.Find<CheckBox>(PART_CheckBox);
    ...
    private void SyncSelectedDateToText(DateTime? date)
    {
        ...
        {
            _textBox?.SetValue(TextBox.TextProperty, date.Value.ToString(DisplayFormat ?? "dd.MM.yyyy"));
