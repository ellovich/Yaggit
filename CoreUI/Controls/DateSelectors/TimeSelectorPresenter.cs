...
[TemplatePart(PART_SelectorContainer, typeof(Grid))]
...
public class TimeSelectorPresenter : TemplatedControl
{
    ...
    public const string PART_SelectorContainer = "PART_SelectorContainer";
    ...
    public static readonly StyledProperty<bool> NeedsConfirmationProperty =
        AvaloniaProperty.Register<TimeSelectorPresenter, bool>(
            nameof(NeedsConfirmation));

    public static readonly StyledProperty<int> MinuteIncrementProperty =
        AvaloniaProperty.Register<TimeSelectorPresenter, int>(
    ...
    public static readonly StyledProperty<TimeSpan?> TimeProperty =
        AvaloniaProperty.Register<TimeSelectorPresenter, TimeSpan?>(
            nameof(Time));

    public static readonly StyledProperty<string> PanelFormatProperty =
        AvaloniaProperty.Register<TimeSelectorPresenter, string>(
    ...
    private Grid? _SelectorContainer;
    ...
    static TimeSelectorPresenter()
    {
        PanelFormatProperty.Changed.AddClassHandler<TimeSelectorPresenter, string>((presenter, args) =>
            presenter.OnPanelFormatChanged(args));
        TimeProperty.Changed.AddClassHandler<TimeSelectorPresenter, TimeSpan?>((presenter, args) =>
            presenter.OnTimeChanged(args));
    }

    public TimeSelectorPresenter()
    {
    ...
    public static readonly RoutedEvent<TimeChangedEventArgs> SelectedTimeChangedEvent =
        RoutedEvent.Register<TimeSelectorPresenter, TimeChangedEventArgs>(
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        if (_secondSelector is not null) _secondSelector.SelectionChanged += OnPanelSelectionChanged;
        if (_ampmSelector is not null) _ampmSelector.SelectionChanged += OnPanelSelectionChanged;
        _SelectorContainer = e.NameScope.Find<Grid>(PART_SelectorContainer);
    ...
    {
        if (_SelectorContainer is null) return;
        if (_hourSelector is not null)
        {
