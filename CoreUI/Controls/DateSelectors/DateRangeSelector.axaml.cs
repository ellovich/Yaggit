...
[PseudoClasses(":empty")]
public class DateRangeSelector : DateSelectorBase, IClearControl
{
    ...
    public static readonly StyledProperty<DateTime?> SelectedStartDateProperty =
        AvaloniaProperty.Register<DateRangeSelector, DateTime?>(
    ...
    public static readonly StyledProperty<bool> EnableMonthSyncProperty =
        AvaloniaProperty.Register<DateRangeSelector, bool>(
    ...
    {
        SelectedStartDateProperty.Changed.AddClassHandler<DateRangeSelector, DateTime?>((Selector, args) =>
            Selector.OnSelectionChanged(args));
        SelectedEndDateProperty.Changed.AddClassHandler<DateRangeSelector, DateTime?>((Selector, args) =>
            Selector.OnSelectionChanged(args));
    }
