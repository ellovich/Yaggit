...
public class CalendarView : TemplatedControl
{
    ...
    public static readonly StyledProperty<bool> IsTodayHighlightedProperty =
        DateSelectorBase.IsTodayHighlightedProperty.AddOwner<CalendarView>();

    public static readonly StyledProperty<DayOfWeek> FirstDayOfWeekProperty =
        DateSelectorBase.FirstDayOfWeekProperty.AddOwner<CalendarView>();
    ...
    public static readonly RoutedEvent<CalendarDayButtonEventArgs> DateSelectedEvent =
        RoutedEvent.Register<TimeSelectorPresenter, CalendarDayButtonEventArgs>(
    ...
    private void InitializeGridButtons()
    {
        ...
        for (var i = 0; i < 7; i++)
        {
            ...
            var cell = new TextBlock { Text = info.AbbreviatedDayNames[d], Tag = ShortestDayName };
    ...
    /// <summary>
    /// Used for syncing the context date for DateRangeSelector. mark a flag to avoid infinitely loop.
    /// </summary>
