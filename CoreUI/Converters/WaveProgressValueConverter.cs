...
public class WaveProgressGradientOffsetConverter : IValueConverter
{
    ...
    public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
    {
        ...
        try
        {
            PrimaryColor = Color.Parse("#4C62C9"); // TODO: (Color)Application.Current.FindRequiredResource("SukiPrimaryColor");
            AccentColor = Color.Parse("#1451ae");// TODO: (Color)Application.Current.FindRequiredResource("SukiAccentColor");
        }
        catch { }
